...
function getItems($catID, $rowFrom, $rowNumbers, $pro, $not = "") {
    ...
    $table = "com_video_gallery";
    $catTable = "com_video_gallery_categories";
    $returnData .= $lib->util->com->_getCats($pro, $lang, $catTable, $table, $catID);
    $returnData.= $lib->coms->getMobileData->type = "videos";
    $returnData.= $lib->coms->getMobileData->options['videosCatId'] = $catID;
    $returnData.= $lib->coms->getMobileData->options['pro'] = $pro;
    $returnData.= $lib->coms->getMobileData->_render();
