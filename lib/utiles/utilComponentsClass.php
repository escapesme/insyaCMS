...
<img   alt='" . $da['title'] . "'   src='/images/pixel.gif' data-src='" . $imagePath . "' class='lazy  itemBlock_imgae' />
    ...
    function get_modData_items($pro, $all, $thisTable, $thiscatgoriesTable, $l) {
        ...
        if (!isset($pro['numberView']) || $pro['numberView'] == "") {
            $pro['numberView'] = 4;
        }
        ...
        for ($i = 0; $i < $pro['numberView']; $i++) {
            if (isset($all[$i]['id']) && trim($all[$i]['id']) != "") {
                ...
                if ($pro['viewTitle'] == "1") {
                    ...
                    $returnData.= "<div class='modig_blocTitle'>  <a title='" . $all[$i]['title'] . "' href='" . $url . "'>" . $this->gen->limit_text($all[$i]['title'], $pro['maxTitle']) . "</a></div>";
                }
                ...
                if ($pro['viewImage'] == "1" && ($pro['firstMainStyle'] == "0" || $i < 1)) {
                    ...
                    <img  alt='" . $all[$i]['title'] . "'  src='/images/pixel.gif'  data-original='" . $imagePath . "'  class='lazy mod_image'  /></a> </div>";
                }
                ...
                $returnData.='<div class="button-wrapper"><a href="#"><span class="normal-button">' . $l['more'] . '</span></a></div>';
                $returnData.= "</div>";
            }
        }
