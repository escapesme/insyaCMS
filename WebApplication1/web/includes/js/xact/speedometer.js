    ...
    $.fn.speedometer = function(options) {
        ...
        var def = {
            ...
            thisCss: {
                ...
                fontFamily: 'Arial',
                fontWeight: '900'
                        // backgroundImage: "url('/Xact/images/background.jpg')"
            },
            needleProperties: {
                fulcrumX: 105,
                fulcrumY: 105,
        ...
        var mdata = def.percentage;            /* Are we animating or just displaying the percentage? */
        if (def.status == "1") {
            mdata = def.percentage - 100;
        ...
        else if (def.limit && (def.percentage > def.maximum || def.percentage < def.minimum))
        {
            ...
            if (def.percentageText === "") {


                def.percentageText = def.percentage;
            }


            digitalGauge.text(def.percentageText + def.suffix);
            ...
            function _animate() {
                ...
                if (def.digitalRoll) {
                    ...
                    if (def.textanimate) {
                        digitalGauge.text(coun + def.suffix);
