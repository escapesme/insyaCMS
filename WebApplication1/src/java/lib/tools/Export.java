...
public class Export extends HttpServlet
{
	 ...
	 */
	protected void streamImage(Color bg, String xml, OutputStream stream)throws ParserConfigurationException, SAXException, IOException
	{
		/*mxGraphViewImageReader reader = new mxGraphViewImageReader(bg, 4, true,true);
