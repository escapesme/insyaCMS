 ...
 * @author es
 */
public class adminModulesMenus extends SimpleTagSupport {
      ...
      lib.engine.db.operations DB= new  lib.engine.db.operations();
        try {
            ...
            DB.openDBCon(lib.Options.DbInfo.connectionStringDef);
                out.print("<div><ul>");
         ResultSet rs=   DB.getData("def_install",""," type='mod' and enable=1 ");
         ...
         while (rs.next()){
              String lin="?alias="+ pageContext.getRequest().getParameter("alias")+morlink+"&link="+rs.getString("id")+"&show=add";
