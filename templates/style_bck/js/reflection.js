                ...
                if (/^img$/i.test(c.tagName)) {
                    function d() {
                        ...
                        if (l.getContext) {
                            ...
                            l = a("<img />").attr("src", c.src).css({width: g, height: f, marginBottom: i - f, filter: "FlipV progid:DXImageTransform.Microsoft.Alpha(Opacity=" + (b.opacity * 100) + ", FinishOpacity=0, Style=1, StartX=0, StartY=0, FinishX=0, FinishY=" + (i / f * 100) + ")"})[0]
                        }
...
/*
    $(".Block").mouseover(function() {
        ...
        $(this).find("img").reflect({opacity: 0.5});
    });

    $(".Block").mouseleave(function() {
        $(this).find("img").reflect({height: 0, opacity: 0});
    });*/
