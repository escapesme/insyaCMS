...
<div class=\"select_bar\">" . $this->getSelectData() . "</div>";
        $html.= '<form action="" id="list_form' . $this->table_name . $this->AddToFormName . '" method="post" >';
        ...
        foreach ($this->list as $list => $v) {
            ...
            switch ($this->table_properties[$list]['type']) {
                case "order" :
                    if ($this->users->getUserPermission("canedit") == "1") {
                        $more = "<div title='Save' id=\"" . $myname . "__order\" class=\"thbutton __order doenable  " . $myname . "_order\">"
                ...
                case "enable" :
                    ...
                    if ($this->users->getUserPermission("canedit") == "1") {
                        $more = "<div title='Save' id=\"" . $myname . "__enable\" class=\"thbutton __enable doenable  " . $myname . "_enable\">"
                                . "<i class=\"fa fa-floppy-o\"></i></div>";
                    }
                    break;
            }
    ...
    function get_trs($id = "0", $class = "") {
        ...
        foreach ($data as $dval) {
            ...
            /*
              ...
              $this->riss[$id] = $this->riss[$id] + 1;
              if ($this->riss[$id] == count($data)) {
              $slp = "<span class='last $id'>" . $slp . "</span>";
              }
            ...
            $html.= "<div  id=' tr__" . $dval['id'] . "' class=\"divRow chtr_" . $id . " " . $typestyle . "  " . $islast . "  " . $class . " tr__" . $dval['id'] . "\" >";
            ...
            if ($_GET[$this->variables->url_mode] != 'trash') {
                ...
                if ($this->users->getUserPermission("canedit") == "1") {
                    $html.= "   <a  "
                            . "href=\"" . $this->util->getmyurl("admin", "") . "&" . $this->variables->url_mode . "=edit&" . $this->listOptions['addtolink'] . "&" . $this->variables->url_id . "=" . $dval['id'] . "\"  "
                            . "id=\"edit__" . $dval['id'] . "\" class=\"edit_option\" title='Edit' >
                " . "<li class=\"fa fa-pencil\"></li>  Edit[" . $dval['id'] . "]"
                            . "</a>";
                }


                if ($this->users->getUserPermission("candelete") == "1") {
                    $html.= "<a id=\"del__" . $dval['id'] . "\"class=\"delete_option\" title='Delete' >"
...
// </editor-fold>
            ...
            foreach ($this->list as $list => $v) {
                ...
                $html.="<div   style='width:" . $this->getColwidtth($v["list-width"]) . "' class=\"$myname divCell list_data\">"
                        . "<label class='cellTitle'>" . $this->table_properties[$list]['title'] . "</label><div class='cellvalue'>"
                        . "";
                // <editor-fold defaultstate="collapsed" desc="TDS"> 
                switch ($this->table_properties[$list]['type']) {
                    case "order" :


                        $filds = array(
                            $snam => array("type" => "input", "value" => $dval[$myname], "name" => $myname, "id" => $myname . "__" . $dval['id'], "class" => $myname . "__order input__" . $dval['id'])
                        );
                        $this->formes->filds = $filds;
                        $html.= "<input type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />"
                    ...
                    case "image":
                        ...
                        $src = $this->upload_to . $dval[$this->table_properties[$list]['name']];
                        ...
                        $html.=
                                ...
                                "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                    ...
                    case "enable" :
                        ...
                        $html.= "<input type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />";
                        $html.= ' <input type="checkbox" name="' . $myname . '"  id = "' . $myname . "__" . $dval['id'] . '"  class="' . $myname . "__enable input__" . $dval['id'] . ' ios" ' . $s . '/>';
                    ...
                    case "date" :
                        ...
                        $html.= "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                              " . $slpn . $this->util->dateFromdb($dval[$this->table_properties[$list]['name']]);
                    ...
                    case "editor" :
                        ...
                        $html.= "
                            <a id='" . $this->table_name . "__" . $this->table_properties[$list]['name'] . "__" . $dval['id'] . "' class=\"show_body_html\">
                    ...
                    case "select" :
                        if ($this->table_properties[$list]['select_type'] == "DB" && $this->table_properties[$list]['select_value'] != "") {
                            $gdata = $this->mydb->get_row($this->table_properties[$list]['select_data'], "", $this->table_properties[$list]['select_value'] . "='" . $dval[$this->table_properties[$list]['name']] . "'");

                            $html.= "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                                
                                " . $slpn . " " . $gdata[$this->table_properties[$list]['select_text']];
                        } else {
                            $html.= "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                               
                                " . $slpn . " " . $dval[$this->table_properties[$list]['name']];
                        }
                        break;
                    ...
                    case "list" :
                        if ($this->table_properties[$list]['select_type'] == "DB" && $this->table_properties[$list]['select_value'] != "") {
                            ...
                            $vals = explode(",", $dval[$this->table_properties[$list]['name']]);
                            ...
                            foreach ($vals as $v) {
                                ...
                                $gdata = $this->mydb->get_row($this->table_properties[$list]['select_data'], "", $this->table_properties[$list]['select_value'] . "='" . $v . "'");
                                $html.= $gdata[$this->table_properties[$list]['select_text']] . $coma . " ";
                            }
                        } else {
                            $html.= "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                    ...
                    default :
                        ...
                        $html.= "
                            <input  type='hidden' value='" . $dval['id'] . "__" . $myname . "__" . $this->table_properties[$list]['type'] . "'    class='input__" . $dval['id'] . "__info' />
                                <span title='" . $dval[$this->table_properties[$list]['name']] . "'>" . $slpn . " " . $dval[$this->table_properties[$list]['name']] . "</span>";
                        break;
                }
...
<div class="block-header"><h1>' . $this->my_title . '</h1><span></span></div>
...
';
        ...
        $retdate.= '</div></div>';
        $retdate.= '<div class="clearfix"></div>';
        $this->formes->notLang = "";
        return $retdate;
    }
                ...
                if ($this->mode != "viewList") {
                    ...
                    if ($this->users->getUserPermission("canadd") == "1") {
                        $returndata .=
                                ...
                                "<a title='Add' href='" . $myurl . "&" . $mode . "=add&" . $this->listOptions['addtolink'] . "' >"
        ...
        if (is_array($this->group)) {
            ...
            foreach ($this->group as $k => $v) {
                ...
                if (isset($this->group[$k]['parent']) && $this->group[$k]['parent'] = "yes") {
                    $myurl = "index.php?";
                    $returndata .= "<a class='$moreClass' href=\"" . $myurl . $view_url . "=" . $k . "\">" . $this->util->updatCodes($this->group[$k]['title']) . "</a>";
                } else {
                    ...
                    $returndata .= "<a class='$moreClass' href=\"" . $myurl . "&" . $purl . "&" . $view_url . "=" . $k . "\">" . $this->util->updatCodes($this->group[$k]['title']) . "</a>";
                }
            }
        }
...
// </editor-fold>
    ...
    function updateNew() {
        ...
        if (isset($_POST['status']) && $_POST['status'] == "add") {
            ...
            $mymaxid = $this->mydb->get_row($this->table_name, "max(id) as mid");
...
//print_r($mypro);
            foreach ($mypro as $my) {
                ...
                if ($mypro[$my['name']]['type'] == "order") {
                    ...
                    $mypro[$my['name']]['get_data_body'] = '1111111111111111111111';
    ...
    function getsqlreturn() {
        ...
        for ($i = 0; $i < count($myfnames); $i++) {
            if (isset($myfnames[$i]) && $myfnames[$i] != "") {
                $spliter = " and ";
    ...
    function getdata($withoutlimit, $cat_id) {
        ...
        $this->where = $this->listOptions['view'];
        ...
        if (isset($withoutlimit) && $withoutlimit != "") {
            $where = $this->where . $out . "  " . $od;
        } else {
            $where = $this->where . $out . "  " . $od . " LIMIT " . $ln . "," . $this->listNumber;
        }
        ...
        // $this->table_name.$where.count($data)."<br/>";
