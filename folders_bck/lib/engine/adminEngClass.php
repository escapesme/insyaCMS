...
//put your code here
    ...
    function getMain() {
        ...
        if (
            ...
            $r = $this->getmyMain($myview);
        } else if ($myview == "site_setting" || $myview == "" || $myview == "com_update_my_date") {
            $r = $this->getmyMain($myview);
        } else {
    ...
    function getComponentMain($Componentname = "", $porpertiesFile = "", $mode = "", $moreHtml = "") {
        $returnData = "";
        if ($Componentname == "") {
        ...
        $xmlfile = $this->foldersMap->admin_components_folder . $this->parent . "/" . $dataname . "/" . $porpertiesFile . ".xml";
...
///////////get properties array if module or menu
        ...
        if ($mode == "add") {
            ...
            $opj_properties = $this->returnporteries($porpertiesFile);
...
//print_R($table_properties);
    ...
    function returnporteries($porpertiesFile) {
        ...
        if ($this->proretiesType == "menu") {
            ...
            $xmlfilepro = "../" . $this->foldersMap->fornt_components_folder . $this->proretiesdir . "/" . $porpertiesFile . ".xml";
            $opj_properties = $this->util->readXmlAttributes($xmlfilepro, $this->xml_fldestsgeTag);
        } else if ($this->proretiesType == "module") {
            $xmlfilepro = "../" . $this->foldersMap->fornt_modules_folder . $this->proretiesdir . "/" . $porpertiesFile . ".xml";
            $opj_properties = $this->util->readXmlAttributes($xmlfilepro, $this->xml_fldestsgeTag);
        }

        if ($this->proretiesType == "template") {

            $xmlfilepro = "../" . $this->foldersMap->fornt_templates_folder . $this->proretiesdir . "/" . $porpertiesFile . ".xml";
            $opj_properties = $this->util->readXmlAttributes($xmlfilepro, $this->xml_fldestsgeTag);
        }
