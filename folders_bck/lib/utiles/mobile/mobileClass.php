...
class mobileClass {
    ...
    function viewItemsBlock($pro, $d, $catData) {
        ...
        if (isset($pro['catPageViewDate']) && $pro['catPageViewDate'] == "1") {
            ...
            $returnData.="<div class='itemBlock_date info'>" . $date->format(' l jS F Y') . "/div>";
        }
        ...
        $returnData.= "</div> <a title='More' href='" . $url . "'>";
        ...
        if (isset($pro['catPageViewImage']) && $pro['catPageViewImage'] == "1") {
            ...
            $returnData.= "<img title = \"" . $d['title'] . "\"  alt=\"" . $d['title'] . "\"   class='lazy itemBlock_imgae'  data-src='" . $imagePath . "' src='/images/pixel.gif' />";
        }
        if (isset($pro['catPageViewDes']) && $pro['catPageViewDes'] == "1") {
            $returnData.="<p class='itemBlock_des'>" . $lib->util->data->getText($d['des'], "", $pro['desLimit']) . "</p>";
        }
        $returnData.= "</a> </li>";
