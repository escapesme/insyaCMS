...
//  =  . '<div ' . $moreAttra . ' style="' . $inputStyle . '"  id="' . $inputID . '"  class="' . $inputClass . '"   ></div>';
                ...
                case 'form':
                    ...
                    if ($fild['novalidation'] != "1") {
                        ...
                        $input_html .= '<script> setFormvalidation("' . $inputID . '")</script>';
                    }
...
';
                ...
                case 'div':
                    ...
                    $input_html = $more . '<div  ' . $moreAttra . '  style="' . $inputStyle . '"  id="' . $inputID . '"  class="' . $inputClass . '"   >';
...
//////////////////////////////////////////////
                ...
                case 'date':
                    if ($fild['styleMode'] == "inline") {
                        ...
                        $input_html = '<div  ' . $moreAttra . '  style="' . $inputStyle . '"   id="' . $inputID . '"  class="' . $inputClass . '"  value="' . $inputValue . '"  ></div>';
                    } else {
                    ...
                    $input_html .= '<script>getDate("#' . $inputID . '" ,"' . $fild['styleMode'] . '",".' . $fild['dateto'] . '","' . $fild['minDate'] . '","' . $fild['maxDate'] . '" )</script>';
                    break;
                case 'color':
                    $input_html = '<input  ' . $moreAttra . '  style="' . $inputStyle . '" action="' . $inputAction . '" name="' . $inputName . '" id="' . $inputID . '"  class="' . $inputClass . '"  value="' . $inputValue . '" type="text" />';
                ...
                case 'egphone':
                    ...
                    $input_html = ''
                            ...
                            . '<input  value="' . str_replace($values[0], "", $inputValue) . '"  ' . $moreAttra . '  maxlength="8" style="margin:12px; max-width:190px; ' . $inputStyle . '" action="' . $inputAction . '"   class="phone_num ' . '"  '
                            . '  type="text" />'
...
';
          ...
          <div class='f" . $inputName . "'>
            ...
            <div class=' add addstep'>
                <ul>
            <li title='Update To Text' class=' uToText'><i class=\"fa fa-external-link\"></i> </li>
            <li title='Update  From Text'  class='  uFromText'><i class=\"fa fa-code\"></i></li>
            <li title=' Show/Hide Text'  class=' ToggelText'><i class=\"fa fa-file-text-o\"></i> </li>
            <li title='collapse All'  class='collapseAll'><i class=\"fa fa-angle-double-down\"></i> </li> 
            <li title='collapse All' class='addStepBt '><i class=\"fa fa-plus\"></i></li>
             
 </ul>
            

        </div>
        <div class='stepes'> </div></div>
        <script>
            ...
            var ops = new Array(
             ...
             ,'submit','reset');
                UpdateFromBluder('.f" . $inputName . "','admin/formData_data',ops,'" . $inputValue . "');
                getBluder('.f" . $inputName . "','admin/formData_data',ops);
        </script>";
 ...
 <li title='collapse All'  class='collapseAll ui-state-default ui-corner-all'><span class='ui-icon ui-icon-circlesmall-minus'></span></li>
        ...
        <script>
            ...
            var ops = new Array( 'query',
             ...
             ,'form','Sesstion_data','plugin');
                UpdateFromBluder('.f" . $inputName . "','admin/b_data',ops,'" . $inputValue . "');
                getBluder('.f" . $inputName . "','admin/b_data',ops);
        </script>";
...
'
            ...
            switch ($fild['type']) {
                ...
                default:
                    ...
                    $html.='<div class="field-input" >' . $input_html . '</div>';
...
//   $this->util->sendMassage("succ", $this->util->getLangVar($msgtitle), $this->util->getLangVar($msgBosy));
    ...
    function getFiledsFormStrign($type, $data, $id, $filed, $save = "", $lang = "", $sendmail = "") {
        $REDATA = "";
        $this->filds = "";
        ...
        if ($type == "db") {
            ...
            $mydata = $this->db->get_Row($data, "*", "id='" . $id . "'  and enabled='1' and `delete`='0'");
                    ...
                    switch ($row['type']) {
                        ...
                        case 'form':
                            if (isset($row['saveType']) && $row['saveType'] == "sesstion") {
                                $REDATA .= '<script> setFormvalidation("' . $row['name'] . '" ,"addtosession","' . $row['saveTo'] . '")</script>';
