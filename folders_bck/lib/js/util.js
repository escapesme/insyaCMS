...
function setFormvalidation(Form, more, name) {
    $(function() {
...
function setFormToSesstion(Form, callback, name) {
    ...
    $(function() {
        Form.submit(function() {
            ...
            $.post("/getPostajax.php", {name: name, file: "eng/setSesstion", status: "form", form: $(this).serialize()})
                    .done(function(s) {
...
function selectdepend_on(parent, chiled, type, value) {
    ...
    $(function() {
        ...
        sendPAjax("ajax/eng/updat_select", "parent=" + parent + "&type=" + type + "&val=" + $(p).eq(0).val() + "&value=" + value, function($d) {
        ...
        $(document).on("change", p, function() {
            ...
            $(c).html("<option class='loading ' style=' direction: ltr ; text-align: left'>loading....</option>");
            sendPAjax("ajax/eng/updat_select", "parent=" + parent + "&type=" + type + "&val=" + $(this).val() + "&value=" + value, function($d) {
...
function getaddMore(me, num) {
    ...
    $(function() {
        ...
        <div class='addMore addMoreBT' >addmore</div>";
            $(me).html(alldata);
        });
