...
function getuserData() {
    ...
    if (isset($_SESSION['login'])) {
        ...
        $_SESSION['userData']['mobile'] = $user['mobile'];
    }
...
function cstep_save($s, $lang, $o, $data) {
    ...
    if (($user['mobile_confirm'] == "0" || $user['mobile'] != $_SESSION[$formdata['title']]['mobile']) &&
        ...
        $r .="<div class='info success'> " . $lang['saveDataMsg'] . "</div>";
...
function myemail($lang, $s, $o) {
    ...
    // $data = $lib->db->get_row("com_html", "*", "id=" . $s['mail']);
    ...
    /*
      ...
      <div style="height: 83px; margin: auto; width: 135px;"><img src="@%myimagesurl%@logo_samll_2.png" alt="" /></div>
      ...
      <div style="font-weight: bold; font-size: 15px;">@%mailTitle%@@%session::Madad-Checkout.name%@</div>
      <div>@%maildes%@</div>

      <div style="width: 100%; clear: both; border-bottom: solid 5px  #d7d7d7; margin-top: 20px; line-height: 30px;">@%mailinfoTitle%@</div>
      </td></tr>
      </table>

      <table   style='background:#e2e2e2;  font-size: 15px; font-family: tahoma;' align="center" width="580px">
      ...
      <td style="min-height: 110px; width: 50%;  margin: 0px;">

      <div>@%mailDateTitle%@</div>
      <div style="font-weight: normal;">@form@*******@to@*******</div>
      ...
      <div>@%mailiAddresTitle%@</div>
      <div style="font-weight: normal;">@%session::projcetData.address%@</div>
      ...
      <div style="width: 100%; clear: both; border-bottom: solid 5px  #d7d7d7; font-weight: bold; font-size: 15px; padding-botom: 10px; margin-bottom: 10px; margin-top: 20px; line-height: 30px;">@%mailDateTitle%@</div>
      ...
      <tr align="right">  <td style="min-height: 110px; width: 50%;  margin: 0px;">

      <img width="200" height="110" src="@%myUploadsimagesurl%@@%session::projcetData.th_image%@" alt="" />



      </td>
      <td>
      <table  style='background:#eeeeee;  font-family: tahoma;' align="center" width="330">



      <tr style="padding-right: 10px;">
      <td style="padding-right: 10px; width: 130px; float: right;">@%mailProject%@</td>
      <td>@%session::projcetData.title%@</td>
      </tr>
      <tr style="padding-right: 10px;">
      <td style="padding-right: 10px; width: 130px; float: right;">@%mailRes%@</td>
      <td>@%session::projcetData.title%@</td>
      </tr>
      <tr style="padding-right: 10px;">
      <td style="padding-right: 10px; width: 130px; float: right;">@%mailAmount%@</td>
      <td>@%session::projcetData.amount%@ @%currency%@</td>
      </tr>
      <tr style="padding-right: 10px;">
      <td style="padding-right: 10px; width: 130px; float: right;">@%mailFee%@</td>
      <td>@%session::projcetData.collection-fee%@ @%currency%@</td>
      </tr>
      <tr>
      <td style="padding-right: 10px; width: 130px; float: right;">@%mailAll%@</td>
      <td>@%session::projcetData.all%@ @%currency%@</td>
      </tr>
      ...
      <div style="clear: both; float: left; width: 150px;">@%mailTeam%@</div>

      </td></tr>
      <tr align="center"><td>
      <div style="clear: both; width: 100%; border-top: solid 3px  #d7d7d7; padding-top: 10px; margin-top: 10px;">@%mailNots1%@lll</div>

      </td></tr></table>


      <table  style='  color: #ffffff;  font-family: tahoma;' align="center" width="580px">
      <tr align="center"><td>
      @%mailNots1%@
      </td></tr></table>
      </div>
    ...
    /*
      $r = $lib->util->data->TextVarUpdate($lang, $htmldata);

      $lib->util->sendMail("azizms@hotmail.com;empcland@gmail.com;empcland@hotmail.com", $r, "ismial", "ismial", "empcland@gmail.com");
     */
