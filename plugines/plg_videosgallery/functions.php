...
function plgvi_gatData($id, $pro) {
    ...
    $mydata = '<div class="vid_pluign"> <div class="pagination-next">></div>
    ...
    $mydata .= '</ul></div></div><div class="dev7-caroufredsel-pag"></div><script>'
            . '$(function(){'
            . '$(\'.list_carousel ul\').carouFredSel(
                {
                speed:800, btnNext:\'.vid_pluign .pagination-next\'
                ,btnPrev:\'.vid_pluign  .pagination-prev\', responsive: true,items: ' . $pro['vidimagesNumber'] . '}) '
            . '})'
            . '</script>';
