...
function plgig_gatData($id, $pro) {
    ...
    $mydata = '<div class="img_pluign"> <div class="pagination-next">></div>
    ...
    foreach ($datasql as $d) {
     ...
     $mydata .= '</ul></div></div><div class="dev7-caroufredsel-pag"></div><script>'
            ...
            . '$(\'.list_carousel ul\').carouFredSel(
                {
                speed:800, btnNext:\'.img_pluign .pagination-next\'
                ,btnPrev:\'.img_pluign  .pagination-prev\', responsive: true,items: ' . $pro['imagesNumber'] . '}) '
            . '})'
            . '</script>';
